...
function Projects() {
  ...
  return (
    ...
    <div className='lefttop-topic'>
     ...
     <p>Welcome to my project space - a collection of ideas brought to life through code, design, and experimentation. Here you’ll find everything from research-driven builds to practical tools, each created to challenge my skills and explore new possibilities in technology.hjjhdhhfhjdfkhdkj</p>
    </div>
